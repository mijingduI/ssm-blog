...
<#--        <h3>${t.id} : ${t.title}</h3>-->
                ...
                <div class="inner">
                    <div class="user_card">
                        <div>
                            ...
                            <span class="user_name"><a class="dark" href="/topic">${username}</a></span>
    ...
    <span class="count_of_visits" title="点击数">
      ...
      <span class="last_active_time">${(currentTime - t.createdTime)/86400} 天前</span>
    </span>
    ...
    <span class="count_of_visits" title="点击数">
      4390
                    ...
                    <a class="last_time pull-right" href="/topic">
                        ...
                        <span class="last_active_time">${(currentTime - u.commentList[0].updatedTime)/86400} 天前</span>
                    </a>
